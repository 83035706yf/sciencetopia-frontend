            ...
            <v-tab-item v-if="activeTab === 0">
                ...
                <v-card class="mb-3 study-plan-card">
                    <v-card-item>
                        <v-row>
                            <v-col cols="11">
                                <StudyPlan :userId="userId" :studyPlan="studyPlan"
                ...
                <v-row>
                    <v-col v-for="studyPlan in activeStudyPlans" :key="studyPlan.studyPlan.id" cols="12">
                        <v-card v-if="studyPlan.studyPlan.id != studyPlanId" class="study-plan-summary">
                            <v-progress-linear v-bind="props" :model-value="studyPlan.studyPlan.progressPercentage"
                                color="text" height="15" striped></v-progress-linear>
                            <!-- <v-spacer style="height: 5px;"></v-spacer> -->
                            <v-progress-linear v-if="studyPlan.studyPlan.advancedTopicProgressPercentage > 0"
                                v-bind="props" :model-value="studyPlan.studyPlan.advancedTopicProgressPercentage"
                                color="accent" height="15" striped></v-progress-linear>
                            <v-row align="center">
                                <v-col cols="4">
